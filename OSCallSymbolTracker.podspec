...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/794895276@qq.com/OSCallSymbolTracker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '794895276@qq.com' => '794895276@qq.com' }
  s.source           = { :git => 'https://github.com/794895276@qq.com/OSCallSymbolTracker.git', :tag => s.version.to_s }
